...
/**
 * NcmLv1Position20161018 generated by hbm2java
 */
@Entity
@Table(name = "NCM_LV1_POSITION_20161018", schema = "NCM")
public class NcmLv1Position20161018 implements java.io.Serializable {

	private NcmLv1Position20161018Id id;

	public NcmLv1Position20161018() {
	}

	public NcmLv1Position20161018(NcmLv1Position20161018Id id) {
		this.id = id;
	}
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "subHldFaceAmt", column = @Column(name = "SUB_HLD_FACE_AMT", precision = 20)),
			@AttributeOverride(name = "subBookAmt", column = @Column(name = "SUB_BOOK_AMT", precision = 20)),
			@AttributeOverride(name = "subMktEvalAmt", column = @Column(name = "SUB_MKT_EVAL_AMT", precision = 20)),
	...
	public NcmLv1Position20161018Id getId() {
		return this.id;
	}

	public void setId(NcmLv1Position20161018Id id) {
		this.id = id;
	}
