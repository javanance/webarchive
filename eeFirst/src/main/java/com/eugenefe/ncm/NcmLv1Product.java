...
public class NcmLv1Product implements java.io.Serializable {
	...
	@AnnoMethodTree(order=16, init=true)
...
/*	private String id;
	...
	public boolean equals(Object obj){
		if( obj instanceof NcmLv1Product){
			return new EqualsBuilder().append(getFinProdId(), ((NcmLv1Product)obj).finProdId).isEquals();
		}
		else {
			return false;
		}
	...
	@Override
	public int hashCode(){
		return new HashCodeBuilder().append(getFinProdId()).hashCode();
	}
