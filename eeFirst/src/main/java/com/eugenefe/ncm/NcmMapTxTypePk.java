 ...
 */
@Embeddable
public class NcmMapTxTypePk implements java.io.Serializable {

	private String srcTable;
	private String srcProdTypeCd;
	private String srcTradeTypeCd;

	public NcmMapTxTypePk() {
	}

	public NcmMapTxTypePk(String srcTable, String srcProdTypeCd, String srcTradeTypeCd) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmMapTxTypePk))
			return false;
		NcmMapTxTypePk castOther = (NcmMapTxTypePk) other;
