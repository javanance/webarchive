...
public class NcmLv1SubPosition implements java.io.Serializable {

	private NcmLv1SubPositionId id;
	...
	public NcmLv1SubPosition(NcmLv1SubPositionId id) {
		this.id = id;
	}

	public NcmLv1SubPosition(NcmLv1SubPositionId id, BigDecimal invAmt, BigDecimal hldQty, BigDecimal hldFaceAmt,
	...
	public NcmLv1SubPositionId getId() {
		return this.id;
	}

	public void setId(NcmLv1SubPositionId id) {
		this.id = id;
	}
