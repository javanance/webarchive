...
public class NcmLv1Transaction implements java.io.Serializable {
	...
	private NcmLv1TransactionId id;
	...
	public NcmLv1Transaction(NcmLv1TransactionId id) {
		this.id = id;
	}

	public NcmLv1Transaction(NcmLv1TransactionId id, String bizDivCd, String acctDivCd, String cptlDivCd, String acctNo,
			String txTypeCd, String buySellDivCd, String finProdId, String mngOrgCorpNo, BigDecimal fstTxAmt,
			BigDecimal bdayBal, BigDecimal txAmt, BigDecimal txQty, BigDecimal txPrice, BigDecimal intAmt,
			BigDecimal prepayCorpTax, BigDecimal prepayCorpLtax, BigDecimal todayBal, String bookingNo,
			String bookingDate, String fstFinTxNo, String srcTable, String updateId, Date lastUpdate) {
		this.id = id;
	...
	public NcmLv1TransactionId getId() {
		return this.id;
	}

	public void setId(NcmLv1TransactionId id) {
		this.id = id;
	}
