...
public class NcmErpPositionHis implements java.io.Serializable {

	private NcmErpPositionHisId id;
	...
	public NcmErpPositionHis(NcmErpPositionHisId id) {
		this.id = id;
	}

	public NcmErpPositionHis(NcmErpPositionHisId id, String acctDiv, String bizDiv, String bizDivNm, String captDiv,
	...
	public NcmErpPositionHisId getId() {
		return this.id;
	}

	public void setId(NcmErpPositionHisId id) {
		this.id = id;
	}
