...
public class NcmLv2PosRisk implements java.io.Serializable {
	...
	public NcmLv2PosRisk(NcmLv2PosRiskId id, BigDecimal stdev, BigDecimal var, BigDecimal te) {
		this.id = id;
		this.stdev = stdev;
		this.var = var;
		this.te = te;
	...
	public NcmLv2PosRisk(NcmLv2PosRiskId id, BigDecimal stdev, BigDecimal var, BigDecimal te, String srcTable,
	...
	public NcmLv2PosRiskId getId() {
		return this.id;
	}

	public void setId(NcmLv2PosRiskId id) {
		this.id = id;
	}
