...
public class NcmLv2BmRisk implements java.io.Serializable {

	private NcmLv2BmRiskId id;
	...
	public NcmLv2BmRisk(NcmLv2BmRiskId id, BigDecimal stdev, BigDecimal var, BigDecimal te) {
		this.id = id;
		this.stdev = stdev;
		this.var = var;
		this.te = te;
	...
	public NcmLv2BmRisk(NcmLv2BmRiskId id, BigDecimal stdev, BigDecimal var, BigDecimal te, String srcTable,
	...
	public NcmLv2BmRiskId getId() {
		return this.id;
	}

	public void setId(NcmLv2BmRiskId id) {
		this.id = id;
	}
