...
/**
 * NcmLv1MmtDetail20161007Id generated by hbm2java
 */
@Embeddable
public class NcmLv1MmtDetail20161007Id implements java.io.Serializable {
	...
	public NcmLv1MmtDetail20161007Id() {
	}

	public NcmLv1MmtDetail20161007Id(String mmtProdId, String mmtChgProdId) {
		this.mmtProdId = mmtProdId;
		this.mmtChgProdId = mmtChgProdId;
	}

	public NcmLv1MmtDetail20161007Id(String mmtProdId, String mmtChgProdId, String srcTable, String updateId,
			Date lastUpdate) {
		this.mmtProdId = mmtProdId;
		this.mmtChgProdId = mmtChgProdId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmLv1MmtDetail20161007Id))
			return false;
		NcmLv1MmtDetail20161007Id castOther = (NcmLv1MmtDetail20161007Id) other;
