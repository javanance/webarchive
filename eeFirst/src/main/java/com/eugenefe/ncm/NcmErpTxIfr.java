...
public class NcmErpTxIfr implements java.io.Serializable {
	...
	public NcmErpTxIfr(NcmErpTxIfrId id) {
		this.id = id;
	}

	public NcmErpTxIfr(NcmErpTxIfrId id, String bizDiv, String bizDivNm, String captDiv, String captDivNm,
	...
	public NcmErpTxIfrId getId() {
		return this.id;
	}

	public void setId(NcmErpTxIfrId id) {
		this.id = id;
	}
