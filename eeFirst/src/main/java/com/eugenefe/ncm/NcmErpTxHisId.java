...
/**
 * NcmErpTxHisId generated by hbm2java
 */
@Embeddable
public class NcmErpTxHisId implements java.io.Serializable {

	private String baseDate;
	private String finTxNo;

	public NcmErpTxHisId() {
	}

	public NcmErpTxHisId(String baseDate, String finTxNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmErpTxHisId))
			return false;
		NcmErpTxHisId castOther = (NcmErpTxHisId) other;
