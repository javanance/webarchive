...
public class NcmErpAccountIfs implements java.io.Serializable {
	...
	public NcmErpAccountIfs(String baseDate) {
		this.baseDate = baseDate;
	}

	public NcmErpAccountIfs(String baseDate, String eaiPttn, Date eaiCreDttm, String eaiTrstType, Date eaiTrstDttm,
			String errMsg) {
		this.baseDate = baseDate;
