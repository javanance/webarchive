...
public class NcmLv1PositionBackId implements java.io.Serializable {
	...
	public NcmLv1PositionBackId(String baseDate, String posId) {
		this.baseDate = baseDate;
		this.posId = posId;
	}

	public NcmLv1PositionBackId(String baseDate, String posId, String bizDivCd, String acctDivCd, String acctNo,
			String saaCd, String finProdId, String mngOrgCorpNo, BigDecimal fstTxAmt, BigDecimal hldQty,
			BigDecimal hldFaceAmt, BigDecimal bookAmt, BigDecimal bdayEvalAmt, BigDecimal mktEvalAmt,
			...
			BigDecimal spread, String matCd, String fstTxDate, String finTxNo, String creditCd, String creditOrgCd,
			String creditTypeCd, String srcTable, String updateId, Date lastUpdate) {
		this.baseDate = baseDate;
		this.posId = posId;
