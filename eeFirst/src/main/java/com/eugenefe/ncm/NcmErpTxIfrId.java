...
/**
 * NcmErpTxIfrId generated by hbm2java
 */
@Embeddable
public class NcmErpTxIfrId implements java.io.Serializable {

	private long eaiSeqNo;
	private String baseDate;
	private String finTxNo;

	public NcmErpTxIfrId() {
	}

	public NcmErpTxIfrId(long eaiSeqNo, String baseDate, String finTxNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmErpTxIfrId))
			return false;
		NcmErpTxIfrId castOther = (NcmErpTxIfrId) other;
