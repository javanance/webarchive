...
/**
 * NcmMapKfrFund generated by hbm2java
 */
@Entity
@Table(name = "NCM_MAP_KFR_FUND", schema = "NCM")
public class NcmMapKfrFund implements java.io.Serializable {

	private NcmMapKfrFundId id;
	...
	public NcmMapKfrFund() {
	}

	public NcmMapKfrFund(NcmMapKfrFundId id, String srcProdTypeCd) {
		this.id = id;
		this.srcProdTypeCd = srcProdTypeCd;
	}

	public NcmMapKfrFund(NcmMapKfrFundId id, String srcProdTypeCd, String srcProdTypeNm, String srcCparty,
	...
	public NcmMapKfrFundId getId() {
		return this.id;
	}

	public void setId(NcmMapKfrFundId id) {
		this.id = id;
	}
