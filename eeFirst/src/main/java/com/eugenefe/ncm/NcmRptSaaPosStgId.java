...
/**
 * NcmRptSaaPosStgId generated by hbm2java
 */
@Embeddable
public class NcmRptSaaPosStgId implements java.io.Serializable {
	...
	public NcmRptSaaPosStgId() {
	}

	public NcmRptSaaPosStgId(String baseDate, String prodTypeCd, String matCd, String acctDivCd, String cptlDivCd,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmRptSaaPosStgId))
			return false;
		NcmRptSaaPosStgId castOther = (NcmRptSaaPosStgId) other;
