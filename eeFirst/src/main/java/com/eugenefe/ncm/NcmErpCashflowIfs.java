...
/**
 * NcmErpCashflowIfs generated by hbm2java
 */
@Entity
@Table(name = "NCM_ERP_CASHFLOW_IFS", schema = "NCM")
public class NcmErpCashflowIfs implements java.io.Serializable {
	...
	public NcmErpCashflowIfs() {
	}

	public NcmErpCashflowIfs(String baseDate) {
		this.baseDate = baseDate;
	}

	public NcmErpCashflowIfs(String baseDate, Character flag, String eaiPttn, Date eaiCreDttm, String eaiTrstType,
