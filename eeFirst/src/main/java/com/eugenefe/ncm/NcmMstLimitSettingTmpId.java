...
public class NcmMstLimitSettingTmpId implements java.io.Serializable {
	...
	public NcmMstLimitSettingTmpId(String applyStDate, String applyCd, String lmtTypeCd, BigDecimal lmtMinAmt,
			BigDecimal lmtMaxAmt) {
	...
	public NcmMstLimitSettingTmpId(String applyStDate, String applyCd, String lmtTypeCd, String applyEndDate,
			BigDecimal lmtMinAmt, BigDecimal lmtMaxAmt, String useYn, String srcTable, String updateId,
			Date lastUpdate) {
		this.applyStDate = applyStDate;
		this.applyCd = applyCd;
		this.lmtTypeCd = lmtTypeCd;
	...
	public boolean equals(Object other) {
		...
		return ((this.getApplyStDate() == castOther.getApplyStDate()) || (this.getApplyStDate() != null
				...
				&& ((this.getLmtMinAmt() == castOther.getLmtMinAmt()) || (this.getLmtMinAmt() != null
						&& castOther.getLmtMinAmt() != null && this.getLmtMinAmt().equals(castOther.getLmtMinAmt())))
				&& ((this.getLmtMaxAmt() == castOther.getLmtMaxAmt()) || (this.getLmtMaxAmt() != null
						&& castOther.getLmtMaxAmt() != null && this.getLmtMaxAmt().equals(castOther.getLmtMaxAmt())))
				&& ((this.getUseYn() == castOther.getUseYn()) || (this.getUseYn() != null
						&& castOther.getUseYn() != null && this.getUseYn().equals(castOther.getUseYn())))
