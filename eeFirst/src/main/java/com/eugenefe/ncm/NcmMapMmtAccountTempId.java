...
public class NcmMapMmtAccountTempId implements java.io.Serializable {
	...
	public NcmMapMmtAccountTempId(String srcTable, String srcAcctNo, String srcFinTxNo, String srcProdTypeCd) {
	...
	public NcmMapMmtAccountTempId(String srcTable, String srcAcctNo, String srcFinTxNo, String srcProdTypeCd,
			...
			BigDecimal srcIssuAmt, BigDecimal srcIntRate, String finProdId, String updateId, Date lastUpdate) {
		this.srcTable = srcTable;
		this.srcAcctNo = srcAcctNo;
		this.srcFinTxNo = srcFinTxNo;
		this.srcProdTypeCd = srcProdTypeCd;
	...
	public boolean equals(Object other) {
		...
		return ((this.getSrcTable() == castOther.getSrcTable()) || (this.getSrcTable() != null
				...
				&& ((this.getSrcIssuAmt() == castOther.getSrcIssuAmt()) || (this.getSrcIssuAmt() != null
						&& castOther.getSrcIssuAmt() != null && this.getSrcIssuAmt().equals(castOther.getSrcIssuAmt())))
				&& ((this.getSrcIntRate() == castOther.getSrcIntRate()) || (this.getSrcIntRate() != null
						&& castOther.getSrcIntRate() != null && this.getSrcIntRate().equals(castOther.getSrcIntRate())))
