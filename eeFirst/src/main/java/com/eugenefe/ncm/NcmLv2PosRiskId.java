...
/**
 * NcmLv2PosRiskId generated by hbm2java
 */
@Embeddable
public class NcmLv2PosRiskId implements java.io.Serializable {

	private String baseDate;
	private String posId;

	public NcmLv2PosRiskId() {
	}

	public NcmLv2PosRiskId(String baseDate, String posId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmLv2PosRiskId))
			return false;
		NcmLv2PosRiskId castOther = (NcmLv2PosRiskId) other;
