...
/**
 * NcmErpPositionIfs generated by hbm2java
 */
@Entity
@Table(name = "NCM_ERP_POSITION_IFS", schema = "NCM")
public class NcmErpPositionIfs implements java.io.Serializable {
	...
	public NcmErpPositionIfs() {
	}

	public NcmErpPositionIfs(String baseDate) {
		this.baseDate = baseDate;
	}

	public NcmErpPositionIfs(String baseDate, String eaiPttn, Date eaiCreDttm, String eaiTrstType, Date eaiTrstDttm,
			String errMsg) {
		this.baseDate = baseDate;
