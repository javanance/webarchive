...
/**
 * NcmLv2SubRiskId generated by hbm2java
 */
@Embeddable
public class NcmLv2SubRiskId implements java.io.Serializable {

	private String baseDate;
	private String posId;

	public NcmLv2SubRiskId() {
	}

	public NcmLv2SubRiskId(String baseDate, String posId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmLv2SubRiskId))
			return false;
		NcmLv2SubRiskId castOther = (NcmLv2SubRiskId) other;
