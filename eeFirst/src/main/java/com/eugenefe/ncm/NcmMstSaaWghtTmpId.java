...
public class NcmMstSaaWghtTmpId implements java.io.Serializable {
	...
	public NcmMstSaaWghtTmpId(String saaCd) {
		this.saaCd = saaCd;
	}

	public NcmMstSaaWghtTmpId(String applyStDate, String saaCd, Short saaOrder, Short saaLevel, BigDecimal targetYield,
			BigDecimal targetWght, BigDecimal torlError, String bmId, String applyEndDate, String srcTable,
	...
	public boolean equals(Object other) {
		...
		return ((this.getApplyStDate() == castOther.getApplyStDate()) || (this.getApplyStDate() != null
				...
				&& ((this.getSaaOrder() == castOther.getSaaOrder()) || (this.getSaaOrder() != null
						&& castOther.getSaaOrder() != null && this.getSaaOrder().equals(castOther.getSaaOrder())))
				...
				&& ((this.getTargetYield() == castOther.getTargetYield())
						|| (this.getTargetYield() != null && castOther.getTargetYield() != null
								&& this.getTargetYield().equals(castOther.getTargetYield())))
				&& ((this.getTargetWght() == castOther.getTargetWght()) || (this.getTargetWght() != null
						&& castOther.getTargetWght() != null && this.getTargetWght().equals(castOther.getTargetWght())))
				&& ((this.getTorlError() == castOther.getTorlError()) || (this.getTorlError() != null
						&& castOther.getTorlError() != null && this.getTorlError().equals(castOther.getTorlError())))
