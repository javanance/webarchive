...
public class NcmRptPosDetail implements java.io.Serializable {
	...
	public NcmRptPosDetail(NcmRptPosDetailId id) {
		this.id = id;
	}

	public NcmRptPosDetail(NcmRptPosDetailId id, String cptlDivCd, String cptlDivNm, String saaCd, String saaCdNm,
			String finProdId, String finProdNm, String prodTypeCd, String prodTypeNm, String sellerCorpNo,
			String sellerNm, String sellerTypeCd, String sellerTypeNm, String issuDate, String matDate,
			String issuerCorpNo, String issuerNm, String subProdNm, String subProdTypeCd, String subProdTypeNm,
			String subIssuerCorpNo, String subIssuerNm, String matCd, String creditTypeCd, String unastNm,
			String unastPubNm, String unastCrdtGd, String fstTxDate, BigDecimal invAmt, BigDecimal hldQty,
			BigDecimal hldFaceAmt, BigDecimal bookAmt, BigDecimal mktEvalAmt, BigDecimal evalPl,
			BigDecimal todayAccrInt, String srcTable, String updateId, Date lastUpdate, BigDecimal ytm,
			BigDecimal intRate) {
		this.id = id;
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "posDiv", column = @Column(name = "POS_DIV", nullable = false, length = 10)),
			@AttributeOverride(name = "posId", column = @Column(name = "POS_ID", nullable = false, length = 100)),
			@AttributeOverride(name = "subProdId", column = @Column(name = "SUB_PROD_ID", nullable = false, length = 100)),
			@AttributeOverride(name = "finTxNo", column = @Column(name = "FIN_TX_NO", nullable = false, length = 10)) })
	public NcmRptPosDetailId getId() {
		return this.id;
	}

	public void setId(NcmRptPosDetailId id) {
		this.id = id;
	}
