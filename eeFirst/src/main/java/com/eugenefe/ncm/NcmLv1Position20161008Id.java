...
/**
 * NcmLv1Position20161008Id generated by hbm2java
 */
@Embeddable
public class NcmLv1Position20161008Id implements java.io.Serializable {
	...
	public NcmLv1Position20161008Id() {
	}

	public NcmLv1Position20161008Id(String baseDate, String posId) {
		this.baseDate = baseDate;
		this.posId = posId;
	}

	public NcmLv1Position20161008Id(String baseDate, String posId, String bizDivCd, String acctDivCd, String cptlDivCd,
			String acctNo, String saaCd, String finProdId, String mngOrgCorpNo, String fstFinTxNo, BigDecimal fstTxAmt,
			BigDecimal hldQty, BigDecimal hldFaceAmt, BigDecimal bookAmt, BigDecimal bdayEvalAmt, BigDecimal mktEvalAmt,
			BigDecimal intInflowAmt, BigDecimal evalPl, BigDecimal todayAccrInt, BigDecimal accuAccrInt,
			BigDecimal unrealIntAmt, BigDecimal todayBuyAmt, BigDecimal todaySellAmt, BigDecimal todayTradePl,
			BigDecimal ytm, BigDecimal adjDur, BigDecimal spread, String matCd, String fstTxDate, String finTxNo,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmLv1Position20161008Id))
			return false;
		NcmLv1Position20161008Id castOther = (NcmLv1Position20161008Id) other;
