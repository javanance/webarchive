...
/**
 * NcmMmtUnderPfId generated by hbm2java
 */

public class NcmMmtUnderPfId implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmMmtUnderPfId))
			return false;
		NcmMmtUnderPfId castOther = (NcmMmtUnderPfId) other;
