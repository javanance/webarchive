...
@Entity(name = "NaviNcmErpTxIfr20161018")
@IdClass(value = NcmErpTxIfr20161018Id.class)
@Table(name = "NCM_ERP_TX_IFR_20161018", schema = "NCM")
public class NcmErpTxIfr20161018 implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmErpTxIfr20161018))
			return false;
		NcmErpTxIfr20161018 castOther = (NcmErpTxIfr20161018) other;
