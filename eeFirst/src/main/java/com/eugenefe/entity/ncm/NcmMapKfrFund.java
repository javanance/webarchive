...
@Entity(name = "NaviNcmMapKfrFund")
@IdClass(value = NcmMapKfrFundId.class)
@Table(name = "NCM_MAP_KFR_FUND", schema = "NCM")
public class NcmMapKfrFund implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmMapKfrFund))
			return false;
		NcmMapKfrFund castOther = (NcmMapKfrFund) other;
