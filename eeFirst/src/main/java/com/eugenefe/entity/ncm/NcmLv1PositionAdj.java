...
@Entity(name = "NaviNcmLv1PositionAdj")
@IdClass(value = NcmLv1PositionAdjId.class)
@Table(name = "NCM_LV1_POSITION_ADJ", schema = "NCM")
public class NcmLv1PositionAdj implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmLv1PositionAdj))
			return false;
		NcmLv1PositionAdj castOther = (NcmLv1PositionAdj) other;
