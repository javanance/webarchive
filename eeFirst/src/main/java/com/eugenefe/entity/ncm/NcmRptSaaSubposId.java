...
/**
 * NcmRptSaaSubposId generated by hbm2java
 */

public class NcmRptSaaSubposId implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmRptSaaSubposId))
			return false;
		NcmRptSaaSubposId castOther = (NcmRptSaaSubposId) other;
		...
		return ((this.getBaseDate() == castOther.getBaseDate())
				...
				&& ((this.getSubProdTypeCd() == castOther.getSubProdTypeCd())
						|| (this.getSubProdTypeCd() != null && castOther.getSubProdTypeCd() != null && this.getSubProdTypeCd().equals(castOther.getSubProdTypeCd())))
