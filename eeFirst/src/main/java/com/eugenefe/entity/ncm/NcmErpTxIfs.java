...
@Entity(name = "NaviNcmErpTxIfs")
@Table(name = "NCM_ERP_TX_IFS", schema = "NCM")
public class NcmErpTxIfs implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmErpTxIfs))
			return false;
		NcmErpTxIfs castOther = (NcmErpTxIfs) other;
