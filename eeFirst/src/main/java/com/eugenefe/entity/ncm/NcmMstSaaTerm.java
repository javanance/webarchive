...
@Entity(name = "NaviNcmMstSaaTerm")
@Table(name = "NCM_MST_SAA_TERM", schema = "NCM")
public class NcmMstSaaTerm implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmMstSaaTerm))
			return false;
		NcmMstSaaTerm castOther = (NcmMstSaaTerm) other;
