...
@Entity(name = "NaviNcmErpTxHis")
@IdClass(value = NcmErpTxHisId.class)
@Table(name = "NCM_ERP_TX_HIS", schema = "NCM")
public class NcmErpTxHis implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmErpTxHis))
			return false;
		NcmErpTxHis castOther = (NcmErpTxHis) other;
