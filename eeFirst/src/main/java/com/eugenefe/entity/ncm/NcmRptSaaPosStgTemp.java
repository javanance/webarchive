...
@Entity(name = "NaviNcmRptSaaPosStgTemp")
@IdClass(value = NcmRptSaaPosStgTempId.class)
@Table(name = "NCM_RPT_SAA_POS_STG_TEMP", schema = "NCM")
public class NcmRptSaaPosStgTemp implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmRptSaaPosStgTemp))
			return false;
		NcmRptSaaPosStgTemp castOther = (NcmRptSaaPosStgTemp) other;
