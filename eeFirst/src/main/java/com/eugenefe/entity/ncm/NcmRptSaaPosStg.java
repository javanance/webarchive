...
@Entity(name = "NaviNcmRptSaaPosStg")
@IdClass(value = NcmRptSaaPosStgId.class)
@Table(name = "NCM_RPT_SAA_POS_STG", schema = "NCM")
public class NcmRptSaaPosStg implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmRptSaaPosStg))
			return false;
		NcmRptSaaPosStg castOther = (NcmRptSaaPosStg) other;
