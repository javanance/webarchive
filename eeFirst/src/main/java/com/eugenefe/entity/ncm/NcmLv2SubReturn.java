...
@Entity(name = "NaviNcmLv2SubReturn")
@IdClass(value = NcmLv2SubReturnId.class)
@Table(name = "NCM_LV2_SUB_RETURN", schema = "NCM")
public class NcmLv2SubReturn implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmLv2SubReturn))
			return false;
		NcmLv2SubReturn castOther = (NcmLv2SubReturn) other;
