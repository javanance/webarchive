...
@Entity(name = "NaviNcmRptSaaPosNew")
@IdClass(value = NcmRptSaaPosNewId.class)
@Table(name = "NCM_RPT_SAA_POS_NEW", schema = "NCM")
public class NcmRptSaaPosNew implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmRptSaaPosNew))
			return false;
		NcmRptSaaPosNew castOther = (NcmRptSaaPosNew) other;
