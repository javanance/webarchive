...
@Entity(name = "NaviNcmErpPositionIfr")
@IdClass(value = NcmErpPositionIfrId.class)
@Table(name = "NCM_ERP_POSITION_IFR", schema = "NCM")
public class NcmErpPositionIfr implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmErpPositionIfr))
			return false;
		NcmErpPositionIfr castOther = (NcmErpPositionIfr) other;
