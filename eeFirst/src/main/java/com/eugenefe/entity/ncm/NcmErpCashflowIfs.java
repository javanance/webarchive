...
@Entity(name = "NaviNcmErpCashflowIfs")
@Table(name = "NCM_ERP_CASHFLOW_IFS", schema = "NCM")
public class NcmErpCashflowIfs implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmErpCashflowIfs))
			return false;
		NcmErpCashflowIfs castOther = (NcmErpCashflowIfs) other;
