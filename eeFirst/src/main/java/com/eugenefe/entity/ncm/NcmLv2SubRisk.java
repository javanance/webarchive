...
@Entity(name = "NaviNcmLv2SubRisk")
@IdClass(value = NcmLv2SubRiskId.class)
@Table(name = "NCM_LV2_SUB_RISK", schema = "NCM")
public class NcmLv2SubRisk implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmLv2SubRisk))
			return false;
		NcmLv2SubRisk castOther = (NcmLv2SubRisk) other;
