...
@Entity(name = "NaviNcmMapKfrFundSub")
@IdClass(value = NcmMapKfrFundSubId.class)
@Table(name = "NCM_MAP_KFR_FUND_SUB", schema = "NCM")
public class NcmMapKfrFundSub implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmMapKfrFundSub))
			return false;
		NcmMapKfrFundSub castOther = (NcmMapKfrFundSub) other;
