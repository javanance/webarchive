...
@Entity(name = "NaviNcmRptSaaSubposStg")
@IdClass(value = NcmRptSaaSubposStgId.class)
@Table(name = "NCM_RPT_SAA_SUBPOS_STG", schema = "NCM")
public class NcmRptSaaSubposStg implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmRptSaaSubposStg))
			return false;
		NcmRptSaaSubposStg castOther = (NcmRptSaaSubposStg) other;
