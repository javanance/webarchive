...
@Entity(name = "NaviNcmLv1MmfDetail")
@IdClass(value = NcmLv1MmfDetailId.class)
@Table(name = "NCM_LV1_MMF_DETAIL", schema = "NCM")
public class NcmLv1MmfDetail implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmLv1MmfDetail))
			return false;
		NcmLv1MmfDetail castOther = (NcmLv1MmfDetail) other;
