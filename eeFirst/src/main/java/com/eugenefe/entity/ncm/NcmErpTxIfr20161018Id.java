...
public class NcmErpTxIfr20161018Id implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		return (this.getEaiSeqNo() == castOther.getEaiSeqNo())
				...
				&& ((this.getBizDiv() == castOther.getBizDiv()) || (this.getBizDiv() != null && castOther.getBizDiv() != null && this.getBizDiv().equals(castOther.getBizDiv())))
				&& ((this.getBizDivNm() == castOther.getBizDivNm())
						|| (this.getBizDivNm() != null && castOther.getBizDivNm() != null && this.getBizDivNm().equals(castOther.getBizDivNm())))
				&& ((this.getCaptDiv() == castOther.getCaptDiv())
						|| (this.getCaptDiv() != null && castOther.getCaptDiv() != null && this.getCaptDiv().equals(castOther.getCaptDiv())))
				&& ((this.getCaptDivNm() == castOther.getCaptDivNm())
						|| (this.getCaptDivNm() != null && castOther.getCaptDivNm() != null && this.getCaptDivNm().equals(castOther.getCaptDivNm())))
				...
				&& ((this.getTxTypeNm() == castOther.getTxTypeNm())
						|| (this.getTxTypeNm() != null && castOther.getTxTypeNm() != null && this.getTxTypeNm().equals(castOther.getTxTypeNm())))
				&& ((this.getProdNm() == castOther.getProdNm()) || (this.getProdNm() != null && castOther.getProdNm() != null && this.getProdNm().equals(castOther.getProdNm())))
				&& ((this.getFstFinTxNo() == castOther.getFstFinTxNo())
						|| (this.getFstFinTxNo() != null && castOther.getFstFinTxNo() != null && this.getFstFinTxNo().equals(castOther.getFstFinTxNo())))
				&& ((this.getCntPrty() == castOther.getCntPrty())
						|| (this.getCntPrty() != null && castOther.getCntPrty() != null && this.getCntPrty().equals(castOther.getCntPrty())))
				&& ((this.getCntPrtyNm() == castOther.getCntPrtyNm())
						|| (this.getCntPrtyNm() != null && castOther.getCntPrtyNm() != null && this.getCntPrtyNm().equals(castOther.getCntPrtyNm())))
				...
				&& ((this.getTermStDate() == castOther.getTermStDate())
						|| (this.getTermStDate() != null && castOther.getTermStDate() != null && this.getTermStDate().equals(castOther.getTermStDate())))
				&& ((this.getTermEdDate() == castOther.getTermEdDate())
						|| (this.getTermEdDate() != null && castOther.getTermEdDate() != null && this.getTermEdDate().equals(castOther.getTermEdDate())))
				&& ((this.getOrigAmt() == castOther.getOrigAmt())
						|| (this.getOrigAmt() != null && castOther.getOrigAmt() != null && this.getOrigAmt().equals(castOther.getOrigAmt())))
				&& ((this.getAcctCode() == castOther.getAcctCode())
						|| (this.getAcctCode() != null && castOther.getAcctCode() != null && this.getAcctCode().equals(castOther.getAcctCode())))
				&& ((this.getAcctCodeNm() == castOther.getAcctCodeNm())
						|| (this.getAcctCodeNm() != null && castOther.getAcctCodeNm() != null && this.getAcctCodeNm().equals(castOther.getAcctCodeNm())))
				&& ((this.getPayAmt() == castOther.getPayAmt()) || (this.getPayAmt() != null && castOther.getPayAmt() != null && this.getPayAmt().equals(castOther.getPayAmt())))
				...
				&& ((this.getCorpTaxAmt() == castOther.getCorpTaxAmt())
						|| (this.getCorpTaxAmt() != null && castOther.getCorpTaxAmt() != null && this.getCorpTaxAmt().equals(castOther.getCorpTaxAmt())))
				&& ((this.getMuniTaxAmt() == castOther.getMuniTaxAmt())
						|| (this.getMuniTaxAmt() != null && castOther.getMuniTaxAmt() != null && this.getMuniTaxAmt().equals(castOther.getMuniTaxAmt())))
				&& ((this.getResidualAmt() == castOther.getResidualAmt())
						|| (this.getResidualAmt() != null && castOther.getResidualAmt() != null && this.getResidualAmt().equals(castOther.getResidualAmt())))
				&& ((this.getBookingDate() == castOther.getBookingDate())
						|| (this.getBookingDate() != null && castOther.getBookingDate() != null && this.getBookingDate().equals(castOther.getBookingDate())))
				&& ((this.getBookingNo() == castOther.getBookingNo())
						|| (this.getBookingNo() != null && castOther.getBookingNo() != null && this.getBookingNo().equals(castOther.getBookingNo())))
				&& ((this.getCreDttm() == castOther.getCreDttm())
						|| (this.getCreDttm() != null && castOther.getCreDttm() != null && this.getCreDttm().equals(castOther.getCreDttm())))
				&& ((this.getChgDttm() == castOther.getChgDttm())
						|| (this.getChgDttm() != null && castOther.getChgDttm() != null && this.getChgDttm().equals(castOther.getChgDttm())))
				&& ((this.getEaiPttn() == castOther.getEaiPttn())
						|| (this.getEaiPttn() != null && castOther.getEaiPttn() != null && this.getEaiPttn().equals(castOther.getEaiPttn())))
				&& ((this.getEaiCreDttm() == castOther.getEaiCreDttm())
						|| (this.getEaiCreDttm() != null && castOther.getEaiCreDttm() != null && this.getEaiCreDttm().equals(castOther.getEaiCreDttm())))
				&& ((this.getEaiTrstType() == castOther.getEaiTrstType())
						|| (this.getEaiTrstType() != null && castOther.getEaiTrstType() != null && this.getEaiTrstType().equals(castOther.getEaiTrstType())))
				&& ((this.getEaiTrstDttm() == castOther.getEaiTrstDttm())
						|| (this.getEaiTrstDttm() != null && castOther.getEaiTrstDttm() != null && this.getEaiTrstDttm().equals(castOther.getEaiTrstDttm())))
