...
@Entity(name = "NaviNcmErpPositionIfs")
@Table(name = "NCM_ERP_POSITION_IFS", schema = "NCM")
public class NcmErpPositionIfs implements java.io.Serializable, Navigatable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcmErpPositionIfs))
			return false;
		NcmErpPositionIfs castOther = (NcmErpPositionIfs) other;
