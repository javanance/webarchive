...
@Entity(name = "TempStock")
@Table(name = "STOCK", schema = "TAKION79")
public class TempStock implements java.io.Serializable, Navigatable, TempMarketVari {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TempStock))
			return false;
		TempStock castOther = (TempStock) other;
